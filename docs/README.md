...
- [Authentication](authentication.md) — session-based `auth.Guard` (register/login/logout), "remember me" persistent login, password reset, `AuthController`, the `"auth"` middleware
